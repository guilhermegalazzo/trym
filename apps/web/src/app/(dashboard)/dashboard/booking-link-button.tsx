...
export function BookingLinkButton({ venueId }: { venueId: string }) {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      >
        {copied ? (
          <><Check className="h-4 w-4 text-brand-500" strokeWidth={1.5} /><span className="text-brand-600">Copiado!</span></>
        ) : (
      ...
      {open && (
        ...
        >
          <div className="px-4 pt-3 pb-2">
            <p className="text-[10px] font-bold uppercase tracking-[0.12em] text-text-tertiary">Enviar link para clientes</p>
          </div>
          ...
          >
            ...
            <div className="text-left">
              <p className="font-semibold text-text-primary text-sm">Copiar link</p>
